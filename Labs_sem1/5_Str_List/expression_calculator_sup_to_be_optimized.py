    ...
    while len_numbers > 1:
        ...
        if expression_numbers[0][1] < expression_operations[0][1] < expression_numbers[1][1]:
            ...
            if expression_operations[0][0] in ['додати', 'плюс']:
                operation_result = int(expression_numbers[0][0]) + int(expression_numbers[1][0])
...
# change operation minus/plus to *1 / *(-1)

print( calculate_expression("Скільки буде 2 додати 10 помножити на 7?"))
